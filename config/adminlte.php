...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/pharmacy.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'classes_brand' => '',
    'classes_brand_text' => '',
    'classes_content_wrapper' => 'similar-image',
    ...
    */
    ...
    'menu' => [
        [
        'header' => 'Anda Login Sebagai Pemilik',
        'can'    => 'pemilik-only'
        ],
        [
        'text' => 'Dashboard',
        ...
        [
        'header' => 'Anda Login Sebagai Gudang',
        'can'    => 'gudang-only'
        ],
        [
        'text' => 'Pembelian',
        ...
        [
        'header' => 'Anda Login Sebagai Kasir',
        'can'    => 'kasir-only'
        ],
        [
        'text' => 'Penjualan',
